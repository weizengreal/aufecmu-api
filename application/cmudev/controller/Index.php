<?php
namespace app\cmudev\controller;

use think\Request;

use app\cmudev\logic\UserAuth;
use app\cmudev\logic\Note;
...
class Index
{
    ...
    * */
    ...
    {
//        $result = $this->note->_getAllData(1,'');
//        dump($result);
        dump('test');
    }
    ...
    public function _getAllData()
    {
        ...
        if (is_numeric($page)) {
            ...
            if ($fitArr['errcode'] == 1) {
                return [
                        'data' => $this->note->_getAllData($page, $this->request->get("theme", null))
                    ] + getApiMsg(1);
            } else {
                return [
                        'data' => null,
